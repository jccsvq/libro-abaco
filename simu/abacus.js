 ...
 * @(#)abacus.js
 *
 * Copyright 2015 - 2024  David A. Bagley, bagleyd AT verizon.net
 *
 * All rights reserved.
 *
...
var es = {
  ...
  "Add": "Sumar",
  "adding": "sumando",
  "adding_digit": "sumando dígito",
  "Adding": "Sumando",
  "addition_order": "orden de suma",
  "Almost_done": "Casi terminé la posición, necesito agregar 1 al lugar en el que estoy trabajando.",
  "Answer": "Respuesta",
  "A_O_field_value": "Valor del campo A-O",
  "borrow": "tomar prestado",
  "borrowing": "tomando prestado",
  "Borrowing": "Tomando prestado",
  "carry": "llevar",
  "carrying": "llevando",
  "Carrying": "Llevando",
  "Carrying_in_right_A_O_field": "Llevando en el campo A-O derecho",
  "cube": "cubo",
  "Cube": "Cubo",
  "Current_answer": "Respuesta actual",
  "divide_by": "dividir por",
  "Dividing": "Dividiendo",
  "Division_overflow": "Desbordamiento de división",
  "Division_underflow": "Subdesbordamiento de división",
  "do_nothing": "nada que hacer",
  "Done": "Hecho",
  "Final_answer": "Resultado final",
  "For_rail": "para la varilla",
  ...
  "multiplication_order": "orden de multiplicación",
  "Multiplying": "Multiplicando",
  "Now_try_a_smaller_value": "Ahora probamos un valor menor",
  "on_first_auxiliary_rail": "en la primera varilla auxiliar",
  "on_next_move": "en el siguiente movimiento",
  "on_second_auxiliary_rail": "en la segunda varilla auxiliar",
  "onto_lower_deck": "sobre el marco inferior",
  "onto_upper_deck": "sobre el marco superior",
  "part_of": "parte de",
  "P_O_field_value": "valor del campo P-O",
  "put_on": "poner en",
  "register": "registrar",
  "Right": "Derecha",
  "right_to_left": "derecha a izquierda",
  "root_of": "raíz de",
  "Root_underflow": "Subdesbordamiento de raíz",
  "square": "cuadrado",
  "Square": "Cuadrado",
  "Subtract": "Restar",
  "subtracting_digit": "restando dígito",
  "Subtracting": "Restando",
  "Subtraction_underflow": "Subdesbordamiento de resta",
  "take_off": "quitar",
  "Taking": "Tomando",
  "to_left_at_position": "to left A-O field, offset digit at position",
  "to_left_by_corresponding": "to left A-O field, offset digit by corresponding group (or position)",
  "to_right_by_corresponding": "to right A-O field, offset digit by corresponding position",
  "Try_a_smaller_value": "Intente un valor menor",
  "with_borrow": "tomando prestado",
  "with_carry": "llevando",
  "works_best_with_lee_option": "funciona mejor con la opción Lee",
  "Yes_OK_to_iterate": "Sí, de acuerdo con la iteración",
};
var fr = {
  "Add": "Ajouter",
  "Adding": "Ajoutant",
...
var THIRD_UNCIA = "duella"; /* u (actually a Greek
    letter mu μ), AKA binae sextulae */
...
setFormat : function(display, format) {
    ...
    this.grainImages = new Array(2);
    this.grainImages[0] = new Image();
    this.grainImages[0].src = "grain_lr.gif";
    this.grainImages[1] = new Image();
    this.grainImages[1].src = "grain_tb.gif";
...
drawFramePart : function(coord, tb) {
    if (this.vertical) {
    ...
    try {
        this.drawingContext.fillStyle =
            this.drawingContext.createPattern(this.grainImages[tb], 'repeat');
    } catch (e) {
...
function initLeeAbacus(canvas0Element, canvas1Element, canvasElement,
    ...
    for (var i = 0; i < number; i++) {
        ...
        if (i === 0) {
            ...
            /*style = "background-image: url('grain_tb.gif')"
                + "; vertical-align: bottom; display:inline-block;";*/
